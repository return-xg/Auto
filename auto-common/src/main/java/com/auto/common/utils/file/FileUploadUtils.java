package com.auto.common.utils.file;
...
import com.auto.common.exception.file.FileNameLengthLimitExceededException;
import com.auto.common.exception.file.FileSizeLimitExceededException;
import com.auto.common.exception.file.InvalidExtensionException;
import com.auto.common.utils.DateUtils;
import com.auto.common.utils.StringUtils;
import com.auto.common.utils.uuid.IdUtils;
import com.auto.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AutoConfig.getProfile();
    ...
    {
        int dirLastIndex = AutoConfig.getProfile().length() + 1;
